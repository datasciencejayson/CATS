...
if numType == 'HIC': 
    ...
    print('\n Using HIC list to pull HIC information from SAS databases, \n this should take approximatly 10-20 minutes, n\ but may take longer.')
...
#forward = 'H:/hic/hiclist.xlsx'
#backward = 'H:\hic\hiclist.xlsx'
#both1 = 'H:\hic/hiclist.xlsx'
#both2 = 'H:/hic\hiclist.xlsx'
#
#Path(both2).is_file()
#
#file = forward
